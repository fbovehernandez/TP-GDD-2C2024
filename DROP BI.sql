...
ALTER TABLE SARTEN_QUE_LADRA.Hechos_Factura DROP CONSTRAINT IF EXISTS fk_factura_tiempo;
ALTER TABLE SARTEN_QUE_LADRA.Hechos_Factura DROP CONSTRAINT IF EXISTS fk_factura_concepto;
ALTER TABLE SARTEN_QUE_LADRA.Hechos_Factura DROP CONSTRAINT IF EXISTS fk_factura_provincia;
...
DROP PROCEDURE IF EXISTS SARTEN_QUE_LADRA.BI_Marca;
DROP PROCEDURE IF EXISTS SARTEN_QUE_LADRA.BI_Subrubro;
...
DROP VIEW IF EXISTS SARTEN_QUE_LADRA.RENDIMIENTO_DE_RUBROS;
DROP VIEW IF EXISTS SARTEN_QUE_LADRA.PORCENTAJE_DE_FACTURACION_POR_CONCEPTO;
DROP VIEW IF EXISTS SARTEN_QUE_LADRA.FACTURACION_POR_PROVINCIA;
