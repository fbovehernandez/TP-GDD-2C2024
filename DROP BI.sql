...
ALTER TABLE SARTEN_QUE_LADRA.BI_VentaXRubro DROP CONSTRAINT IF EXISTS fk_biventaxrubro_venta;
ALTER TABLE SARTEN_QUE_LADRA.BI_VentaXRubro DROP CONSTRAINT IF EXISTS fk_biventaxrubro_rubro;
...
DROP TABLE IF EXISTS SARTEN_QUE_LADRA.BI_VentaXRubro;
...
DROP PROCEDURE IF EXISTS SARTEN_QUE_LADRA.BI_Migrar_VentaXRubro;
