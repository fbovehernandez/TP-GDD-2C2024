...
AS BEGIN
	SELECT VENTA_CODIGO, CAST(CAST(VENTA_FECHA AS NVARCHAR(50))AS DATE), CAST(CAST(VENTA_FECHA AS NVARCHAR(50))AS TIME), VENTA_TOTAL 
	FROM gd_esquema.Maestra--Se podría aprovechar  #PagoMedioDetalle agregando un par de columnas
